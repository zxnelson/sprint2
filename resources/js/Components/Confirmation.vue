<template>
    <div id="confirmation" class="flex flex-col items-center space-y-4 w-full">
        <h2 class="text-lg font-semibold italic">Gracias por realizar su pedido</h2>
        <div class="flex justify-between items-center w-full">
            ...
            <div>
                <yellow-button as="button" id="print" class="text-sm" @click="print">Imprimir</yellow-button>
            </div>
        </div>
        <div class="w-full">
            <div class="flex justify-between border-t border-b border-black py-2">
                ...
                <div class="flex justify-between w-1/2">
                    <span class="flex-1 text-center">Cantidad</span>
            ...
            <div v-for="(item, index) in order.items" :key="index">
                <div class="flex justify-between border-b border-black py-2">
                    ...
                    <div class="flex justify-between w-1/2">
                        ...
                        <span class="flex-1 text-right">{{ $filters.formatCurrency(item.price) }} </span>
                    </div>
                </div>
            </div>
